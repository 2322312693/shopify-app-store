...
export const PLAN_LIMITS = {
  Free: { label: "Free", limit: 1, period: "lifetime", price: "$0", interval: "lifetime" },
  Starter: { label: "Starter", limit: 50, period: "month", price: "$6.99", interval: "every 30 days" },
  Pro: { label: "Pro", limit: 150, period: "month", price: "$12.99", interval: "every 30 days" },
  Business: { label: "Business", limit: 500, period: "month", price: "$19.99", interval: "every 30 days" },
};
